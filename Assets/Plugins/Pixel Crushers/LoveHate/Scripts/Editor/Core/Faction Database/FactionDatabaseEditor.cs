...
namespace PixelCrushers.LoveHate
{
    ...
    public class FactionDatabaseEditor : Editor
    {
        ...
        protected const float MinMaxValueWidth = 50f;
        ...
        protected virtual void OnDrawPersonalityTraitDefListHeader(Rect rect)
        {
            ...
            EditorGUI.LabelField(new Rect(rect.x + rect.width - MinMaxValueWidth - 2 - MinMaxValueWidth, rect.y, MinMaxValueWidth, rect.height), "Min");
            EditorGUI.LabelField(new Rect(rect.x + rect.width - MinMaxValueWidth, rect.y, MinMaxValueWidth, rect.height), "Max");
        }
        ...
        protected virtual void OnDrawPersonalityTraitDefListElement(Rect rect, int index, bool isActive, bool isFocused)
        {
            if (m_personalityTraitDefList != null && 0 <= index && index <= m_personalityTraitDefList.serializedProperty.arraySize)
            {
                ...
                DrawNameDescriptionRangeListElement(rect, index, isActive, isFocused, true, element);
            }
        }
        ...
        protected virtual void DrawNameDescriptionRangeListElement(Rect rect, int index, bool isActive, bool isFocused, bool isEditable, SerializedProperty element)
        {
            rect.y += 2;
            var nameWidth = GetDefaultNameWidth(rect);
            var descriptionWidth = rect.width - nameWidth - MinMaxValueWidth - MinMaxValueWidth - 8;
            if (isEditable)
            {
                EditorGUI.PropertyField(
                    new Rect(rect.x, rect.y, nameWidth, EditorGUIUtility.singleLineHeight),
            ...
            EditorGUI.PropertyField(
                new Rect(rect.x + nameWidth + 2, rect.y, descriptionWidth, EditorGUIUtility.singleLineHeight),
                element.FindPropertyRelative("description"), GUIContent.none);
            EditorGUI.PropertyField(
                new Rect(rect.x + nameWidth + 2 + descriptionWidth + 2, rect.y, MinMaxValueWidth, EditorGUIUtility.singleLineHeight),
                element.FindPropertyRelative("minValue"), GUIContent.none);
            EditorGUI.PropertyField(
                new Rect(rect.x + nameWidth + 2 + descriptionWidth + 2 + MinMaxValueWidth + 2, rect.y, MinMaxValueWidth, EditorGUIUtility.singleLineHeight),
        ...
        protected virtual void OnDrawRelationshipTraitDefListElement(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            DrawNameDescriptionRangeListElement(rect, index, isActive, isFocused, index > 0, element);
        }
